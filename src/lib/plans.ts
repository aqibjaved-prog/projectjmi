...
export const planSchema = z
  ...
  .refine(
    (v) => v.billing_cycle !== "trial" || (v.duration_days !== null && v.duration_days !== undefined && v.duration_days >= 1),
    { message: "Trial plans require a Trial Duration of at least 1 day.", path: ["duration_days"] },
  );
